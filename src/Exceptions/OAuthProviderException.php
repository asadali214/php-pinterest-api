...
namespace PinterestAPILib\Exceptions;
...
class OAuthProviderException extends ApiException
{
    ...
    /**
     * @param string $reason
     * @param \PinterestAPILib\Http\HttpRequest $request
     * @param \PinterestAPILib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \PinterestAPILib\Http\HttpRequest $request,
        \PinterestAPILib\Http\HttpResponse $response,
        string $error
    ) {
     ...
     * @required
     * @maps error
     * @factory \PinterestAPILib\Models\OAuthProviderErrorEnum::checkValue
     */

...
use PinterestAPILib\Models\OAuthScopeEnum;
use PinterestAPILib\Models\OAuthToken;

class PinterestAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    public function build(): PinterestAPIClient
    {
        return new PinterestAPIClient($this->config);
    }
}
